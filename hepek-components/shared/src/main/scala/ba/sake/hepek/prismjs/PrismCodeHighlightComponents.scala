...
trait PrismCodeHighlightComponents extends CodeHighlightComponents {
  ...
  override def asm6502: PrismCodeHighlighter    = PrismCodeHighlighter("asm6502", showLineNumbers)
  ...
  override def inform7: PrismCodeHighlighter    = PrismCodeHighlighter("inform7", showLineNumbers)
  ...
  override def n4js: PrismCodeHighlighter       = PrismCodeHighlighter("n4js", showLineNumbers)
...
final case class PrismCodeHighlighter(
  ...
  def withLineNumsStart(startFrom: Int): PrismCodeHighlighter =
    this.copy(lineNumbers = Option(startFrom))

  def withLineHighlight(lines: String, offset: Int = 0): PrismCodeHighlighter =
