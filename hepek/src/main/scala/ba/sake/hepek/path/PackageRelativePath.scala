...
/** Path relative to the class' package. <br> E.g. `object MyPage extends PackageRelativePath { def
  * fileName = "mypage.html" }` in `my.company` package renders to `my/company/mypage.html`
  */
