...
// "blog" page with sections
trait HepekDocsAbstractPage extends BlogPostPage with HepekDocsStaticPage {
...
trait HepekDocsStaticPage extends StaticPage with AnchorjsDependencies {
  ...
  override def styleURLs =
    List("https://cdn.jsdelivr.net/npm/@picocss/pico@2.1.1/css/pico.cyan.min.css")
      ++ List(files.styles.`main.css`.ref)
  ...
  override def pageContent = frag(
    ...
    footer(cls := "container flex-centered")(
      ...
      a(href := "https://discord.gg/R2FtxDKyRE")(
        raw("""
          <?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
